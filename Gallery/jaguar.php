...
<nav class="navbar transparent navbar-expand-md sticky-top">
			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item dropdown">
        			...
        			<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          			...
          			<a class="dropdown-item hover-this" href="jaguar.php">Jaguar</a>
	...
	<div>
			<center><h2>Bienvenu dans la page voiture de Jaguar</h2></center>
		<hr/>
		<br/>
	</div>
		...
		<div class="container-fluid voitureMargin">
           	...
           	<?php
                ...
                $sql = "SELECT * FROM voiture WHERE Marque= 'Jaguar'";
