...
<nav class="navbar transparent navbar-expand-md sticky-top">
			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item dropdown">
        			...
        			<div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          			<a class="dropdown-item hover-this" href="mercedes.php">Mercedes</a>
          			<a class="dropdown-item" href="audi.php">Audi</a>
          			<a class="dropdown-item" href="jaguar.php">Jaguar</a>
          			<a class="dropdown-item" href="astonMartin.php">Aston Martin</a>
        			</div>
        		</li>
	...
	<div>
		<center><h2>Bienvenu dans la page voiture de Mercedes</h2></center>
		<hr/>
		<br/>
	</div>
		...
		<div class="container-fluid voitureMargin">
           	...
           	<?php
                ...
                $sql = "SELECT * FROM voiture WHERE Marque= 'Mercedes'";
                ...
                while($row = mysqli_fetch_assoc($result)) {
					$count++;
 							echo "<p class='col-md-12' id='nom'>" ,$row["Modele"], "</p>";
							  ...
							  <div class='carousel-inner'>
						    		<div class='carousel-item active'>
						      		<img class='imageCarousel' src=",$row["image1"]," class='d-block w-80' alt='...'>
						    		</div>
                           ...
                           echo " <table class='table table-hover table-dark' >
                            ...
                            echo "<a href='../Demande D&apos;essai.php?id=$row[id_voiture]'><button type='button' class='btn btn-primary'>Faire une Demande dessai</button></a><hr>";
                            }
                        } else {
                          echo "0 results";
                        }
